...
const UpdateTask = ({idVal}) => {
    const [tasks, setTasks] = useState({ title: "", description: "", id:0 });
    ...
    const handlerDescriptionInput = (e) => {
      ...
      const handlerButton = () => {
        if (tasks.title && tasks.description) {
          ...
          console.log(tasks);
          dispatch({ type: "UPDATING_TASK", payload: tasks });
        }
      };
          ...
          <Dialog.Content className="DialogContent">
            ...
            >
              <Dialog.Close asChild>
                <button onClick={handlerButton} className="Button green">Update changes</button>
              </Dialog.Close>
            </div>
            <Dialog.Close asChild>
